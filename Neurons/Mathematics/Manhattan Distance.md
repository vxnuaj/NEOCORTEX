The Manhattan Distance, also known as the L1 Norm, is the measure of length (magnitude) or distance of a vector relative to the origin in a *taxicab path or grid based system* within a euclidean space.
